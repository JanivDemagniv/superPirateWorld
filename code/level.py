...
class Level:
    def __init__(self, tmx_map , level_frames, data,audio_files, switch_stage):
        ...
        self.semi_coliision_sprites = pygame.sprite.Group()
    ...
    def setup(self,tmx_map, level_frames,audio_files):
        ...
        for layer in ['BG','Terrain','FG','Platforms']:
            for x,y,surf in tmx_map.get_layer_by_name(layer).tiles():
                ...
                if layer == 'Platforms': groups.append(self.semi_coliision_sprites)
                match layer:
        ...
        for obj in tmx_map.get_layer_by_name('Objects'):
            if obj.name == 'player':
                ...
                if obj.name in ('barrel','crate'):
                    ...
                    #groups
                    groups = [self.all_sprites]
                    if obj.name in('palm_small','palm_large'): groups.append(self.semi_coliision_sprites)
    ...
    def pearl_collision(self):
        for sprite in self.collision_sprites:
            ...
            if sprite:
                ParticaleEffectsSprite((sprite[0].rect.center),self.particle_frames,self.all_sprites)
        ...
        for sprite in self.damage_sprites:
            if sprite.rect.colliderect(self.player.hitbox_rect):
                ...
                if hasattr(sprite,'pearl'):
                    sprite.kill()
                    ParticaleEffectsSprite(sprite.rect.center,self.particle_frames,self.all_sprites)
    ...
    def item_collision(self):
        if self.item_sprites:
            ...
            if item_sprites:
                ...
                ParticaleEffectsSprite((item_sprites[0].rect.center),self.particle_frames,self.all_sprites)
    ...
    def check_constraint(self):
        ...
        #success(player getting to the flag - level finished)
