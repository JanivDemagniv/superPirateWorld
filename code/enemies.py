...
class Tooth(pygame.sprite.Sprite):
    def __init__(self, pos,frames,groups,coliision_sprites):
        ...
        self.collision_rects = [sprite.rect for sprite in coliision_sprites]
        self.speed = 200
    ...
    def update(self,dt):
        ...
        if self.frame_index < len(self.frames[self.state]):
            ...
            if self.state == 'fire' and int(self.frame_index) == 3 and not self.has_fired:
                self.create_pearl(self.rect.center if self.bullet_direction > 0 else self.rect.midleft,self.bullet_direction)
                self.has_fired = True
